...
num_clapans = 3  # число клапанов для автогенерации
...
odors_unite = [[1], [4], [32]]  # метки веществ клапанов по группам в порядке!, передаётся в классификатор для обучения
...
weights_filler = [1.2, 1.1, 1.0]  # веса для заглушки для одинаковых весов в обход Коли
