...
num_channels = 16  # число каналов ЭГ+дыхание+метка

num_counter_for_refresh_animal = 195  # количество стимулов для смены животного

count_train_stimuls = 50  # число тренировок
train_step = 10  # число смещений (кол-во клапанов * 5)
...
# odors = [("ТНТ", "#ffff00"), ("КП", "#ffff00"), ("Воздух", "#ffff00")]
odors = [("ТНТ", "#ffff00"), ("НЕ ЦВ", "#ffff00")]  # надписи, выводимые на экран
...
odors_set = [1, 4]  # метки веществ с клапанов, передаётся в классификатор для обучения
odors_test = [1, 2, 4]  # метки веществ с клапанов на тесте
...
# unite = [[0], [1]]  # метки веществ (числовые), для объединения по группам на валидации
...
# unite_test = [[0], [1]]  # Для подсчета результатов при смене клапанов, для вывода по группам на тесте
...
# labels_map = {1: 0, 2: 2, 4: 1}
# labels_map = {1: 0, 4: 1}

validationResult = {i: 0 for i in range(2)}  # словарь для валидации, ключи в порядке, значения нули (авто)
