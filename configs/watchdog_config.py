...
odors = [("ТНТ + КП НП", "#ffff00"), ("Воздух", "#ffff00"), ("КП НП", "#ffff00"),
         ("ТНТ", "#ffff00"), ("Воздух", "#ffff00"),
         ("5", "#ffff00"), ("3", "#ffff00")]  # Расшифровка и цвет вещества (на экран и в таблицу)

odors_set = [9, 16, 8, 1]  # метки веществ (числовые)
...
mixture_groups = [[9],[16],[8], [1] ]  # для классификации по клапанам (для Колиного)
