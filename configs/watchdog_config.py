...
# unite = [[0], [1, 2, 3, 4]]  # метки веществ (числовые), передаётся в классификатор для обучения
# unite = [[0], [1], [2], [3]]  # метки веществ (числовые), передаётся в классификатор для обучения
unite = [[0], [1], [2]]  # метки веществ (числовые), передаётся в классификатор для обучения
