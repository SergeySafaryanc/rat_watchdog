...
num_counter_for_refresh_animal = 115  # количество стимулов для смены животного
...
odors = [("ОВ обнаружено", "#ffff00"), ("Воздух", "#ffff00")]
...
weights = [1, 0.51]  # веса для надклассификатора по группам
...
rat_name = "НПитер"  # для формирования отчёта
