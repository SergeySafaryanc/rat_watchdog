...
# odors = [("ТНТ", "#ffff00"), ("КП", "#ffff00"), ("Воздух", "#ffff00")]
odors = [("НС", "#ffff00"), ("ВВ", "#ffff00"), ("Не ЦВ", "#ffff00"), ("ТЕН15", "#ffff00"), ("КП", "#ffff00"), ("Воздух", "#ffff00")]  # во втором случае OK на английском

# ("Вертилов 2", "#ffff00"),
# ("Губа 2", "#ffff00"), ("Чуб 2", "#ffff00"),
# ("5", "#ffff00"), ("3", "#ffff00")
# ]  # Расшифровка и цвет вещества (на экран и в таблицу)
odors_set = [1, 2, 4, 8, 16, 32]  # метки веществ с клапанов
...
weights = [1, 1, 1.1, 1.1, 0.9, 0.9]  # веса для надклассификатора: ТНТ=1, КП=0.9, Воздух=0.4
...
acc_need_two_ts = 120 # необходимая точность на двух последних валидациях для успешного обучения
acc_need_of_one_clf = 70  # необходимая точность от каждого классификатора в комитете

one_file = False  # костыль, если один файл для обучения и для тестирования, то True

rat_name = "Н64"  # для формирования отчёта
