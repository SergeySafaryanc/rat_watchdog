...
num_counter_for_refresh_animal = num_clapans*39  # количество стимулов для смены животного
count_train_stimuls = num_clapans*10  # число тренировок
...
# weights = [1.1, 1, 1, 0.9, 0.9]  # веса для групп для надклассификатора: НС=1.1, ВВ=1, НЕ ЦВ=0.9
# weights = [1.1, 1.1, 1, 0.9, 0.9]  # веса для групп для надклассификатора: НС=1.1, ВВ=1, НЕ ЦВ=0.9
# weights = [1.1, 1, 0.9, 0.9]  # веса для групп для надклассификатора: НС=1.1, ВВ=1, НЕ ЦВ=0.9
# weights = [1.1, 1, 0.9]  # веса для групп для надклассификатора: НС=1.1, ВВ=1, НЕ ЦВ=0.9
