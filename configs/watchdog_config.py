...
num_counter_for_refresh_animal = 270  # количество стимулов для смены животного
...
odors_set = [1, 2, 4, 8, 16, 32]  # метки веществ (числовые), передаётся в классификатор для обучения

unite = [[0], [1], [2], [3], [4], [5]]  # для вывода результата

unite_test = [[0], [1], [2], [3], [4], [5]]  # Для подсчета результатов при смене клапанов, для вывода результата
