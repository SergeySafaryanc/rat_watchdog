...
num_counter_for_refresh_animal = 235  # количество стимулов для смены животного
...
# odors = [("НС 1", "#ffff00"), ("НС 2", "#ffff00"), ("ВВ", "#ffff00"), ("НЕ ЦВ 1", "#ffff00"), ("НЕ ЦВ 2", "#ffff00")]
# odors = [("НС", "#ffff00"), ("ВВ", "#ffff00"), ("НЕ ЦВ 1", "#ffff00"), ("НЕ ЦВ 2", "#ffff00")]
# odors = [("НС", "#ffff00"), ("ВВ", "#ffff00"), ("НЕ ЦВ", "#ffff00")]

# odors = [("НЕ ЦВ", "#ffff00"), ("НС", "#ffff00"), ("НЕ ЦВ", "#ffff00")]
odors = [("НЕ ЦВ", "#ffff00"), ("НС", "#ffff00"), ("НС", "#ffff00"), ("НС", "#ffff00"), ("НЕ ЦВ", "#ffff00")]


# odors_set = [1, 2, 4, 8, 16, 32]  # метки веществ с клапанов, передаётся в классификатор для обучения
# odors_set = [1, 4, 8, 16, 32]  # метки веществ с клапанов, передаётся в классификатор для обучения
# odors_set = [1, 2, 4, 16, 32]  # метки веществ с клапанов, передаётся в классификатор для обучения
# odors_set = [1, 4, 16, 32]  # метки веществ с клапанов, передаётся в классификатор для обучения
# odors_set = [1, 4, 16]  # метки веществ с клапанов, передаётся в классификатор для обучения

odors_set = [1, 2, 4, 8, 16]  # метки веществ с клапанов, передаётся в классификатор для обучения
# odors_set = [1, 2, 16]  # метки веществ с клапанов, передаётся в классификатор для обучения

# weights = [1, 1, 1.1, 1.1, 0.9, 0.9]  # веса для надклассификатора: НС=1.1, ВВ=1, НЕЦВ=0.9
# weights = [1, 1.1, 1.1, 0.9, 0.9]  # веса для надклассификатора: НС=1.1, ВВ=1, НЕЦВ=0.9
# weights = [1, 1, 1.1, 0.9, 0.9]  # веса для надклассификатора: НС=1.1, ВВ=1, НЕЦВ=0.9
# weights = [1, 1.1, 0.9, 0.9]  # веса для надклассификатора: НС=1.1, ВВ=1, НЕЦВ=0.9
# weights = [1, 1.1, 0.9]  # веса для надклассификатора: НС=1.1, ВВ=1, НЕЦВ=0.9

weights = [0.9, 1.1, 1.1, 1.1, 0.9]  # веса для надклассификатора: НС=1.1, ВВ=1, НЕЦВ=0.9
# weights = [0.9, 1.1, 0.9]  # веса для надклассификатора: НС=1.1, ВВ=1, НЕЦВ=0.9
...
rat_name = "Н71"  # для формирования отчёта
