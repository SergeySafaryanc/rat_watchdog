...
# odors_groups_valtest = [[0], [1], [2], [3], [4]]  # метки групп для объединения на валидации и тесте
odors_groups_valtest = [[i] for i in range(len(odors_unite))]  # В СЛУЧАЕ БЕЗ ГРУПП!
