...
odors = [("ВВ", "#ffff00"), ("НС", "#ffff00"), ("НЕ ЦВ", "#ffff00")]
...
odors_groups_to_valtest = [[0], [1, 2], [3, 4]]  # группы для валидации и теста
...
validationResult = {i: 0 for i in range(len(odors_groups_to_valtest))}  # словарь по порядку, ключи в порядке, значения нули (авто)
