...
epoch_time = 1  #0.04  # sec # время перерыва чтения из файла
...
# odors = [("ТНТ", "#ffff00"), ("КП", "#ffff00"), ("Воздух", "#ffff00")]
odors = [("ЦВ", "#ffff00"), ("НЕ ЦВ", "#ffff00")]  # во втором случае OK на английском
...
weights = [1, 0.51]  # веса для надклассификатора: ТНТ=1, КП=0.9, Воздух=0.4
target_clapan = 1  # клапан ЦВ
...
corr_len = 10000  # 30000  # число отчётов, через которое и на основании которых обновится график
