...
inp_path = "/home/plexon/WatchdogFiles/input"  # для Linux
out_path = "/home/plexon/WatchdogFiles/output"  # для Linux
...
# odors = [("ТНТ", "#ffff00"), ("КП", "#ffff00"), ("Воздух", "#ffff00")]
odors = [("Воздух", "#ffff00"), ("МА3-17", "#ffff00"), ("К1", "#ffff00"), ("МГ4", "#ffff00"), ("КП", "#ffff00")]  # во втором случае OK на английском
...
weights = [0.9, 1, 1, 1, 0.9]  # веса для надклассификатора: ТНТ=1, КП=0.9, Воздух=0.4
