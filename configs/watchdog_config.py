...
odors = [("ЦВ", "#ffff00"), ("Целевые вещества не обнаружены", "#ffff00")]
odors_2 = [("Взрывчатое вещество", "#ffff00"), ("Наркотическое средство", "#ffff00")]

odors_unite = [[1, 2, 4], [16, 32]]  # метки веществ клапанов по группам в порядке!, передаётся в классификатор для обучения
odors_unite_2 = [[1, 2], [4]]  # метки веществ клапанов по группам в порядке!, передаётся в классификатор для обучения
...
weights_filler_1 = [1.1, 0.4]  # веса для заглушки для одинаковых весов в обход Коли
weights_filler_2 = [1.1, 1.0]  # веса для заглушки для одинаковых весов в обход Коли
...
pylib_path = r'../odor_classifier_1'  # путь к классификатору
pylib_path1 = r'../odor_classifier_2'  # путь к классификатору
...
KIR_OUT_LDA_1 = f"pretrained_model_LDA-ORS_1.mdl"
KIR_OUT_LDA_2 = f"pretrained_model_LDA-ORS_2.mdl"
KIR_OUT_SLP_1 = f"pretrained_model_SLP-ORS_1.mdl"
KIR_OUT_SLP_2 = f"pretrained_model_SLP-ORS_2.mdl"
