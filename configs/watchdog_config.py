...
train_step = num_clapans*6  # число смещений (кол-во клапанов * 5)
...
# odors_unite = [[2, 32, 8, 16], [64, 128]]  # метки веществ клапанов по группам в порядке!, передаётся в классификатор для обучения
# odors_unite_2 = [[2, 32], [8, 16]]  # метки веществ клапанов по группам в порядке!, передаётся в классификатор для обучения
