...
N_CHANNELS = 18
f = np.fromfile("/home/quantum/Documents/watchdog_files/out/20210626_13_41_58/train_20210622_13_23_52_no_corr__0_val.dat", "i2")
...
print(f.shape)
print(s.shape)
data_f = np.reshape(f, (-1, N_CHANNELS))
