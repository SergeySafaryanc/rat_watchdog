...
class KirClassifierWrapper:
    ...
    def predict(self, data):
        res = []
        res.append(int(kir_train_seq_SLP1.tst_Spl_original_signal(data)))
        res.append(int(kir_train_seq_SLP_LDA.tst_Spl_original_signal(data)))
        res.append(int(kir_train_seq_SLP_LDA_PT.tst_Spl_original_signal(data)))
        return res
